          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="px-3 py-1 text-sm font-bold uppercase tracking-wide opacity-50 hover:opacity-100 hover:bg-accent hover:text-accent-foreground transition-opacity flex items-center gap-1.5"
                title="Delete list"
              >
